// routes/productsRoutes.js - FIXED ROUTE ORDER
...
router.get('/categories', async (req, res) => {
  try {
    console.log('📦 Fetching categories from /api/products/categories...');
    ...
    console.log('✅ Categories fetched:', transformedCategories.length);
...
// ==================== MAIN PRODUCTS LIST - MUST COME AFTER SPECIFIC ROUTES ====================
...
// Add other review routes (update, delete, helpful, stats) here...
